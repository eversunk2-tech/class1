...
/**
 * sci-6-1-1-2 지시약으로 여러 가지 용액을 분류해 볼까? (sim · 이전 기준)
 * 출처: public/apps/sci-6-1-1-2/app.js buildDetail(), data/lesson-config.js
 * detail: predict{q1,q2}, records[{phase,solution,indicator,result,recordedAt}](indicator는 원본 id),
 *         classify{groups:{acid,base},correct,tries}, analysis.q1..q5, conclusion, extension{q1,q2}, curiosity
 */
