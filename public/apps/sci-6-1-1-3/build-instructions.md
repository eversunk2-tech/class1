# Build 서브에이전트 지침: sci-6-1-1-3

## 목표
승인된 `public/apps/sci-6-1-1-3/spec.md`(확정 결정 절 우선)대로 실험 시뮬레이션 앱을 만든다.
...
* `public/apps/sci-6-1-1-3/spec.md`
...
## 수정 범위
* 수정 가능: `public/apps/sci-6-1-1-3/**`(단 `spec.md`, `*-instructions.md` 수정 금지).
...
## 완료 보고
`public/apps/sci-6-1-1-3/build-report.md`: 파일 목록, spec과 다른 점, 확인한 것/못 한 것.
