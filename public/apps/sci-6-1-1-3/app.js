...
(function () {
  ...
  /* ───────── 4. 정리하기 — 마치기(결과 저장) ───────── */
  // detail(2026-09-25 간략화 뒤, questionSet: 2): predict{q2}, records, analysis{q3,q4}, conclusion, curiosity.
  //   뺀 문항(predict.q1, analysis.q1·q2, extension)의 키는 아예 만들지 않는다 — 관리자 "학생 응답" 매핑이
  //   questionSet으로 간략화 전·후 기록을 가른다(src/data/app-responses/sci-6-1-1-3.ts). detail.qa는 넣지 않는다(spec §1.3).
