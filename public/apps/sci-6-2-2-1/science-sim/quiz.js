/*
 * science-sim/quiz.js — 보기 고르기 분석 퀴즈 + 맞고 틀림 피드백 (정본: scripts/templates/science-sim/)
...
(function () {
  ...
  SciSim.Quiz = {
    render: function (root, questions, store, onChange) {
      var state = store.get("analysis", {}) || {};
      root.textContent = "";
      ...
      questions.forEach(function (q, qi) {
        ...
        fs.appendChild(
          el("legend", { class: "ss-q-label" }, [
            el("span", { class: "ss-q-num", text: "분석 " + (qi + 1) }),
            q.text,
